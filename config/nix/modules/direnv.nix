# Based on: https://github.com/NixOS/nixpkgs/blob/master/nixos/modules/programs/direnv.nix
{
  lib,
  config,
  pkgs,
    ...
    programs = {
      ...
      fish.interactiveShellInit = lib.mkIf cfg.enableFishIntegration ''
        ...
        or printenv PATH | grep -vqc '/nix/store';
         #inline ${lib.getExe cfg.package} hook fish | source
          function __direnv_export_eval --on-event fish_prompt;
              "${lib.getExe cfg.package}" export fish | source;
