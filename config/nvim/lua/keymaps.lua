...
vim.keymap.set("n", "[a", ":<C-U>previous<CR>")
vim.keymap.set("n", "]a", ":<C-U>next<CR>")
vim.keymap.set("n", "[b", ":<C-U>bprevious<CR>")
vim.keymap.set("n", "]b", ":<C-U>bnext<CR>")
vim.keymap.set("n", "[q", ":<C-U>cprevious<CR>")
vim.keymap.set("n", "]q", ":<C-U>cnext<CR>")
vim.keymap.set("n", "[l", ":<C-U>lprevious<CR>")
vim.keymap.set("n", "]l", ":<C-U>lnext<CR>")
-- insert blank line
