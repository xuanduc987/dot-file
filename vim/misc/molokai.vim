...
" Normal mode
let s:N1 = [ '#080808' , '#e6db74' , 232 , 186 ] " mode
let s:N2 = [ '#f8f8f0' , '#232526' , 231 , 16  ] " info
let s:N3 = [ '#f8f8f0' , '#465457' , 231 , 59  ] " statusline
...
let g:airline#themes#molokai#palette.normal_modified = {
      \ 'airline_c': [ '#080808' , '#e6db74' , 232 , 186 , '' ] ,
      \ }


" Insert mode
let s:I1 = [ '#080808' , '#66d9ef' , 232 , 81 ]
let s:I2 = [ '#f8f8f0' , '#232526' , 231 , 16 ]
let s:I3 = [ '#f8f8f0' , '#465457' , 231 , 59 ]
...
let g:airline#themes#molokai#palette.replace.airline_a = [ s:I1[0]   , '#ef5939' , s:I1[2] , 203     , ''     ]
let g:airline#themes#molokai#palette.replace_modified = {
      \ 'airline_c': [ '#080808' , '#ef5939' , 232 , 203, '' ] ,
      \ }


" Visual mode
let s:V1 = [ '#080808' , '#fd971f' , 232 , 208 ]
let s:V2 = [ '#f8f8f0' , '#232526' , 231 , 16  ]
let s:V3 = [ '#f8f8f0' , '#465457' , 231 , 59  ]
...
let g:airline#themes#molokai#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
      \ [ '#f8f8f0' , '#465457' , 231 , 59  , ''     ] ,
      \ [ '#f8f8f0' , '#232526' , 231 , 16  , ''     ] ,
      \ [ '#080808' , '#e6db74' , 232 , 186 , 'bold' ] )
